...
func GetFavoriteCommercialRentalProperties(commercialRentalPropertiesIds []int,
	c *gin.Context) []managerModels.CommercialRentalProperty {
	var properties = []managerModels.CommercialRentalProperty{}
	result := db.DB.Where("id IN ?", commercialRentalPropertiesIds).
